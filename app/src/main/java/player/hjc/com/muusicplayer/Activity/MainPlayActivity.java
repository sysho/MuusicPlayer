package player.hjc.com.muusicplayer.Activity;
...
import player.hjc.com.muusicplayer.common.LrcShow;
import player.hjc.com.muusicplayer.common.MusicAdapter;
import player.hjc.com.muusicplayer.common.MusicHelp;
import player.hjc.com.muusicplayer.common.StringHelper;
import player.hjc.com.muusicplayer.dao.DBProvider;
import player.hjc.com.muusicplayer.dao.SystemService;
...
public class MainPlayActivity extends MainPlayActivityRoot{
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       g.setImageResource(R.drawable.head);
    ...
    protected void onDestroy() {
        ...
        new File("/data/data/player.hjc.com.muusicplayer.activity/shared_prefs/MUSIC.xml")
                .delete();
        new File("/data/data/player.hjc.com.muusicplayer.activity/shared_prefs/SET_MSG.xml")
                .delete();
        System.exit(0);
    };
    /**
